...
class TextClassifier:
    def __init__(self, model_dir='models_15jun'):
        ...
        tokenizer_sen_path = 'models_15jun/ta_sentence_2/tokenizer'
        semantic_sen_model = 'models_15jun/ta_sentence_2/semantic_model.h5'

        tokenizer_par_path = 'models_15jun/ta_paragraph_2/tokenizer'
        semantic_par_model = 'models_15jun/ta_paragraph_2/semantic_model.h5'
        ...
        try:
            ...
            required_files = [
                ...
                f'{model_dir}/ta_sentence_2/reference_embeddings.pkl',
                f'{model_dir}/ta_paragraph_2/reference_embeddings.pkl',
            ]
            ...
            with open(f'{model_dir}/ta_sentence_2/reference_embeddings.pkl', 'rb') as f:
                self.sentence_embeddings = pickle.load(f)

            with open(f'{model_dir}/ta_paragraph_2/reference_embeddings.pkl', 'rb') as f:
...
def home():
    ...
    return render_template('input_stitch.html')
...
def classify():
    ...
    try:
        ...
        return render_template('output_stitch.html', results=results, original_text=text_input)
    except Exception as e:
